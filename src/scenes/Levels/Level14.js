class Level14 extends Phaser.Scene {
    ...
    create(){
        ...
        if (Phaser.Math.Between(1,2) == 1) {
            this.player = this.matter.add.sprite(360, 70, '', null, { shape: this.shapes.circle }).setAngle(180);
        ...
        this.add.text(360, 20, 'Spin to Win Harder', { font: '28px Impact', fill: '#1b2cc2'}).setOrigin(0.5).setDepth(3);
