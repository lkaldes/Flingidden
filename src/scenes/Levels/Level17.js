class Level17 extends Phaser.Scene {
    ...
    create(){
        ...
        if (Phaser.Math.Between(1,2) == 1) {
            this.player = this.matter.add.sprite(20, 440, '', null, { shape: this.shapes.circle }).setAngle(90);
        ...
        this.add.text(360, 20, 'O=E', { font: '28px Impact', fill: '#1b2cc2'}).setOrigin(0.5).setDepth(3);
        ...
        this.matter.world.on('collisionstart', function (event, bodyA, bodyB) {
            if ((bodyA.gameObject && bodyA.gameObject.texture.key == 'goal1') || (bodyB.gameObject && bodyB.gameObject.texture.key == 'goal1')) {
                this.player2score++;
                this.player.setPosition(20, 440);
