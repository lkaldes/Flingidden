class Level3 extends Phaser.Scene {
    ...
    create(){
        ...
        this.sticky2 = this.matter.add.sprite(385, 620, 'sticky', null, { isStatic: true, shape: this.shapes.horizontal_slime }).setScale(3).setOrigin(0.5,0.47);
        ...
        if (Phaser.Math.Between(1,2) == 1) {
            this.player = this.matter.add.sprite(120, 40, '', null, { shape: this.shapes.circle }).setAngle(180);
            this.arrow = this.physics.add.sprite(720/2, 430, 'arrowp2').setSize(30, 30).setOrigin(-0.31,0.45);
        } else {
            this.player = this.matter.add.sprite(120, 870, '', null, { shape: this.shapes.circle });
        ...
        this.add.text(360, 20, "What's this Goop", { font: '28px Impact', fill: '#1b2cc2'}).setOrigin(0.5).setDepth(3);
