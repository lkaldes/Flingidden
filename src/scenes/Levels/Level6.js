class Level6 extends Phaser.Scene {
    ...
    create(){
        ...
        //play music
        this.loopingAudio = this.sound.add("IntersectionMusic").setVolume(0.1);
        ...
        this.add.text(360, 20, 'Angles to the MAX!', { font: '28px Impact', fill: '#1b2cc2'}).setOrigin(0.5).setDepth(3);
